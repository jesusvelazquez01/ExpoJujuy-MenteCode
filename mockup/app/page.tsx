  ...
  return (
    <>
      ...
      <main>
        <section className="hero" id="inicio">
          ...
          <div className="shell hero-layout">
            <div className="hero-copy">
              <p className="eyebrow">
                <span /> ExpoJuy · Edición 2026
              </p>
              <h1>
                Jujuy produce.
                <br />
                <em>Innova.</em> Se conecta.
              </h1>
              ...
              <div className="hero-actions">
                <a className="button button-primary" href="#planifica">
              ...
              <div className="hero-meta">
                <div>
                  <span>Cuándo</span>
                  <strong>Fecha a confirmar</strong>
                </div>
                <div>
                  <span>Dónde</span>
                  <strong>Jujuy · Sede a confirmar</strong>
                </div>
              </div>
            </div>
            <div className="hero-media">
              <div className="hero-image-wrap">
                <Image
                  src={heroImage}
                  alt="Ingreso de visitantes a ExpoJuy durante una edición anterior"
                  fill
                  priority
              ...
              <div className="hero-ticket">
                ...
                <strong>2026</strong>
                <small>Propuesta conceptual</small>
              </div>
              <div className="hero-caption">
                <span>San Salvador de Jujuy</span>
                <span>23.18° S / 65.30° O</span>
              </div>
            </div>
          </div>
        ...
        <section className="manifesto" id="provincia">
          <div className="shell manifesto-grid">
            ...
            <div>
              <p className="manifesto-text">
                ExpoJuy es el punto de encuentro entre quienes producen, quienes
                imaginan y quienes hacen crecer el Norte Argentino.
              </p>
              <div className="metric-row">
                <div>
                  <strong>2026</strong>
                  <span>Una nueva edición</span>
                </div>
                <div>
                  <strong>8+</strong>
                ...
                <div>
                  <strong>1</strong>
                  <span>Experiencia conectada</span>
                </div>
              </div>
              <small className="demo-note">
                Cifras de carácter conceptual para esta instancia de mockup.
              </small>
            </div>
          </div>
        </section>
